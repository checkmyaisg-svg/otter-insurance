...
/**
 * OTTER ICON SET — inline Lucide (ISC) paths, zero npm dependencies.
 *
 * Rules of the design language:
 *  - 1.5px stroke, round caps/joins (Lucide geometry = handcrafted feel)
 *  - default 16px in rows/labels, 20px in nav/headers
 *  - color inherits from text; never hardcode fills
 * Replacing ALL emoji: emoji render inconsistently across OSes and are the
 * single biggest "prototype" tell. These render identically everywhere.
 */
...
export const IconHeartPulse = (p: IconProps) => (
  <svg {...base(p)}><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/><path d="M3.22 12H9.5l.5-1 2 4.5 2-7 1.5 3.5h5.27"/></svg>
);
export const IconActivity = (p: IconProps) => (
  <svg {...base(p)}><path d="M22 12h-2.48a2 2 0 0 0-1.93 1.46l-2.35 8.36a.25.25 0 0 1-.48 0L9.24 2.18a.25.25 0 0 0-.48 0l-2.35 8.36A2 2 0 0 1 4.49 12H2"/></svg>
);
...
export const IconHome = (p: IconProps) => (
  <svg {...base(p)}><path d="M15 21v-8a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v8"/><path d="M3 10a2 2 0 0 1 .709-1.528l7-5.999a2 2 0 0 1 2.582 0l7 5.999A2 2 0 0 1 21 10v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/></svg>
);
...
export const IconCalendarClock = (p: IconProps) => (
  <svg {...base(p)}><path d="M21 7.5V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h3.5"/><path d="M16 2v4"/><path d="M8 2v4"/><path d="M3 10h5"/><circle cx="16" cy="16" r="6"/><path d="M16 14v2l1 1"/></svg>
);
export const IconAlertCircle = (p: IconProps) => (
  <svg {...base(p)}><circle cx="12" cy="12" r="10"/><path d="M12 8v4"/><path d="M12 16h.01"/></svg>
);
export const IconSend = (p: IconProps) => (
  <svg {...base(p)}><path d="M14.536 21.686a.5.5 0 0 0 .937-.024l6.5-19a.496.496 0 0 0-.635-.635l-19 6.5a.5.5 0 0 0-.024.937l7.93 3.18a2 2 0 0 1 1.112 1.11z"/><path d="m21.854 2.147-10.94 10.939"/></svg>
);
...
export const IconCheckBig = (p: IconProps) => (
  <svg {...base(p)}><path d="M21.801 10A10 10 0 1 1 17 3.335"/><path d="m9 11 3 3L22 4"/></svg>
);
